export default function Intro() {
  return <>
    <div className="container">
      <h2 className="text-center lg:text-xl font-bold mt-16">樂趣之餘，不忘學習</h2>
      <h1 className="text-center text-2xl lg:text-3xl font-bold mt-1 lg:mt-3">由資訊社群所打造，超高知識含量的夏令營</h1>
