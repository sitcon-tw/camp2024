export default function Footer() {
  ...
  return <div className="mt-16 bg-[#013249]">
        ...
        <div className="flex flex-row flex-wrap gap-4">
          {
            socialMedias.map(
              socialMedia =>
                <a href={socialMedia.link} target="_blank" className="hover:opacity-80" key={socialMedia.title}>
                  <img src={socialMedia.icon} className="w-5 h-5 inline-block invert" />
                </a>
            )
          }
        </div>
